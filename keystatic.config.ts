  ...
  collections: {
    ...
    libros: collection({
      ...
      schema: {
        ...
        imagen_link: fields.text({ label: 'Enlace de imagen principal (URL externa o ruta /media/...)' }),
        imagenes: fields.array(fields.object({
          src: fields.image({
            label: 'Imagen',
            directory: 'public/media',
            publicPath: '/media/',
        ...
        traducciones: fields.array(fields.object({
        ...
        enlaces: fields.array(fields.object({
